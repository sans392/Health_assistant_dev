...
- Если данные охватывают период больше 7 дней или включают несколько типов
  активности — после основного ответа коротко предложи 1–2 уточнения, например:
  «Хочешь детализацию по дням?» или «Показать разбивку по видам спорта?».
  Не предлагай уточнений, если запрос был про конкретный день или одну метрику."""
